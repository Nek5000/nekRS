function (__MPI_find_compiler LANG QUERY_FLAG OUTPUT_VARIABLE)
  ...
  set(_file "${CMAKE_BINARY_DIR}${CMAKE_FILES_DIRECTORY}/CMakeTmp/src.cxx")
  file(WRITE _file "int main() { return 0; }\n")
  execute_process(
    COMMAND ${MPI_${LANG}_COMPILER} ${_MPI_COMPILER_WRAPPER_OPTIONS} "-c ${_file}"
