            ...
            const adios2::Params &engineParams, const std::string &name)
{
    ...
    while (true)
    {
        ...
        if (status == adios2::StepStatus::OK)
        {
            ...
            VerifyData(myChars.data(), currentStep, startTmp, countTmp, shape, mpiRank);
            VerifyData(myUChars.data(), currentStep, startTmp, countTmp, shape, mpiRank);
            VerifyData(myShorts.data(), currentStep, startTmp, countTmp, shape, mpiRank);
            VerifyData(myUShorts.data(), currentStep, startTmp, countTmp, shape, mpiRank);
            VerifyData(myInts.data(), currentStep, startTmp, countTmp, shape, mpiRank);
            VerifyData(myUInts.data(), currentStep, startTmp, countTmp, shape, mpiRank);
            VerifyData(myFloats.data(), currentStep, startTmp, countTmp, shape, mpiRank);
            VerifyData(myDoubles.data(), currentStep, startTmp, countTmp, shape, mpiRank);
            VerifyData(myComplexes.data(), currentStep, startTmp, countTmp, shape, mpiRank);
            VerifyData(myDComplexes.data(), currentStep, startTmp, countTmp, shape, mpiRank);
