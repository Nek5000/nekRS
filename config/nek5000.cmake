...
ExternalProject_Add(
  ...
  BUILD_COMMAND 
    ...
    "CC=${CMAKE_C_COMPILER}" 
    "CFLAGS=${EXTERNAL_C_FLAGS} ${FPIC_FLAG} ${MCMODEL_FLAG} ${LARGE_DATA_THRES_FLAG}"
    "FC=${CMAKE_Fortran_COMPILER}"
    "FFLAGS=${EXTERNAL_Fortran_FLAGS} ${FPIC_FLAG} ${MCMODEL_FLAG}  ${LARGE_DATA_THRES_FLAG} ${CRAYPTR_FLAG} -I../../../"
