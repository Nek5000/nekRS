...
TEST_F(DataManEngineTest, ReaderSingleBuffer)
{
    // set parameters
    Dims shape = {10};
    Dims start = {0};
    ...
    // run workflow
    adios2::Params readerEngineParams = {
        {"IPAddress", "127.0.0.1"}, {"Port", "12370"}, {"DoubleBuffer", "false"}};
    auto r = std::thread(DataManReader, shape, start, count, steps, readerEngineParams);
    adios2::Params writerEngineParams = {{"IPAddress", "127.0.0.1"}, {"Port", "12370"}};
