...
To setup some cases, for example some periodic boundary conditions or other 
scenarios where conditions have been applied to the mesh, you may need to use the 
``boundaryIDMap`` parameter to apply the ``boundaryTypeMap`` options to the 
correct boundary IDs.
