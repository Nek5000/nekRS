...
for N=1:maxN
  ...
  %% use Gauss-Lobatto quadrature (with unit weight) as nodes 
  r = JacobiGL(0, 0, N);
...
myprint('-dpdf', 'Figures/gllLegendreLebesgueFunction1D.pdf', '-landscape');
...
myprint('-dpdf', 'Figures/gllLegendreLebesgueConstant1D.pdf', '-landscape')
...
set(gca, 'FontName', 'TimesNewRoman'); set(ha, 'FontName', 'TimesNewRoman');
myprint('-dpdf', 'Figures/gllLegendreVandermondeConditionNumber1D.pdf', '-landscape')
...
set(gca, 'FontName', 'TimesNewRoman'); set(ha, 'FontName', 'TimesNewRoman');
myprint('-dpdf', 'Figures/gllLegendreBasisFunctions1D.pdf', '-landscape')
