...
latex_documents = [
    (master_doc, 'ADIOS2.tex', u'ADIOS2 Documentation',
     u'William F Godoy', 'manual'),
]
...
man_pages = [
    (master_doc, 'adios2', u'ADIOS2 Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'ADIOS2', u'ADIOS2 Documentation',
     author, 'ADIOS2', 'One line description of project.',
     'Miscellaneous'),
]
