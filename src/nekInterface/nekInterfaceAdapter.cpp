...
#define fname(s) (strcpy(func, (s)), strcat(func, us), func)
  ...
  check_error(dlerror(), "usrchk");

  nek_ptr_ptr = (void (*)(void **, char *, int *))dlsym(handle,
      fname("nekf_ptr"));
  check_error(dlerror(), "nekf_ptr");
  nek_scptr_ptr = (void (*)(int *, void *))dlsym(handle, fname("nekf_scptr"));
  check_error(dlerror(), "nekf_scptr");
  nek_bootstrap_ptr =
      (void (*)(int *, char *, char *, char *, int, int, int))dlsym(handle,
          fname("nekf_bootstrap"));
  check_error(dlerror(), "nekf_bootstrap");
  nek_setup_ptr =
      (void (*)(int *, int *, int *, int *, int *, double *, double *,
  ...
  nek_restart_ptr = (void (*)(char *, int *))dlsym(handle,
      fname("nekf_restart"));
  ...
  nek_bcmap_ptr = (int (*)(int *, int *, int *))dlsym(handle,
      fname("nekf_bcmap"));
  ...
  nek_set_vert_ptr = (long long (*)(int *, int *))dlsym(handle,
      fname("nekf_set_vert"));
  check_error(dlerror(), "nekf_set_vert");

  nek_setbd_ptr = (void (*)(double *, double *, int *))dlsym(handle,
      fname("setbd"));
  check_error(dlerror(), "setbd");
  nek_setabbd_ptr = (void (*)(double *, double *, int *, int *))dlsym(handle,
      fname("setabbd"));
  ...
  check_error(dlerror(), "nekf_updggem");
