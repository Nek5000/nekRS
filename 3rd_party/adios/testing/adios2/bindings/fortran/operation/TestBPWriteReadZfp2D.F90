program TestBPWriteReadHeatMapZfp2D
  ...
  call adios2_open(bpWriter, ioPut, 'HeatMapZfp2D_f.bp', adios2_mode_write, &
                   ierr)
  ...
  if (irank == 0) then
    ...
    call adios2_open(bpReader, ioGet, 'HeatMapZfp2D_f.bp', &
...
end program TestBPWriteReadHeatMapZfp2D
