...
static int n_x, n_y, n_z, n_elem, n_dim;
...
static int amg_ready = 0;
static long long row_start;
static long long row_end;
static HYPRE_IJMatrix A_bc;
static HYPRE_ParCSRMatrix A_fem;
static HYPRE_IJMatrix B_bc;
static HYPRE_ParCSRMatrix B_fem;
static HYPRE_IJVector Bd_bc;
static HYPRE_ParVector Bd_fem;
static HYPRE_IJVector f_bc;
static HYPRE_ParVector f_fem;
static HYPRE_IJVector u_bc;
static HYPRE_ParVector u_fem;
static HYPRE_IJVector Bf_bc;
static HYPRE_ParVector Bf_fem;
static HYPRE_ParVector Binv_sem;
static HYPRE_Solver amg_preconditioner;
                   ...
                   )
{
    ...
    struct gs_data *gsh = nullptr;
    {
      ...
      gsh = gs_setup(gatherGlobalNodes, NuniqueBases, &comm, 0, gs_pairwise, 0); // gs_auto, gs_crystal_router, gs_pw

      //free(id);
    }

    if (comm.id == 0) printf("fem_amg_setup ...\n");
    static_assert(sizeof(HYPRE_Int) == sizeof(long long), "HYPRE_Int must be long long!\n");
